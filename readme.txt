...
1. Upload the plugin files to the `/wp-content/plugins/gatherpress-onlineevent-or-venue` directory, or install the plugin through the WordPress plugins screen directly.
